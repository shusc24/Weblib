requirejs.config({
	...
	paths:{
        ...
        Vue:"//cdn.bootcss.com/vue/2.2.4/vue.min",
        ...
        //单页面切换
        mobilebone:'lib/webLib/public/plus/mobilebone/mobilebone.min',

        //cookies 工具 github文档:https://github.com/js-cookie/js-cookie
        cookies:'//cdn.bootcss.com/js-cookie/2.1.3/js.cookie.min',

        //input格式化库 github文档 https://github.com/nosir/cleave.js 官网：http://nosir.github.io/cleave.js/
        cleave:'//cdn.bootcss.com/cleave.js/0.7.15/cleave.min',
	...
	shim:{
        ...
        cleave:['//cdn.bootcss.com/cleave.js/0.7.14/addons/cleave-phone.cn.js']
	}
});